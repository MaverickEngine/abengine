...
declare var abengine_length_range_min;
declare var abengine_length_range_max;
declare var abengine_length_target;
export default class LetterCountScorer implements IABEngineScorer {
    length_range: [number, number];
    length_target: number;

    constructor() {
        this.length_range = [abengine_length_range_min || 40, abengine_length_range_max || 90];
        this.length_target = abengine_length_target || 82;
    }
