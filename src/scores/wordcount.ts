...
declare var abengine_wordcount_range_min;
declare var abengine_wordcount_range_max;
declare var abengine_wordcount_target;
export default class WordcountScorer implements IABEngineScorer {
    wordcount_range: [number, number];
    wordcount_target: number;

    constructor() {
        this.wordcount_range = [abengine_wordcount_range_min || 40, abengine_wordcount_range_max || 90];
        this.wordcount_target = abengine_wordcount_target || 82;
    }
